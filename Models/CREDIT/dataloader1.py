...
processed_df = processed_df.loc[processed_df['SeriousDlqin2yrs'] == 1]
...
df.to_csv('free_1.csv', header=False, index=False)

df = pd.DataFrame(conditionals)

df.to_csv('conditionals_1.csv',  header=False, index=False)

df = pd.DataFrame(labels)

df.to_csv('labels_1.csv', header=False,  index=False)